OBJS	= main.o GUI.o TGdesk_login_dial.o TGdesk_main_frame.o TGdesk_add_car_form.o TGdesk_register_dial.o TGdesk_delete_client_form.o TGdesk_add_client_form.o Backend_API.o TGdesk_Register_QR.o TGdesk_import_car_form.o TGdesk_eksport_car_form.o TGdesk_eksport_client_form.o
SOURCE	= *.cpp
OUT	= a.out
CC	 = g++
...
TGdesk_eksport_car_form.o: TGdesk_eksport_car_form.cpp
	$(CC) $(FLAGS) TGdesk_eksport_car_form.cpp

TGdesk_eksport_client_form.o: TGdesk_eksport_client_form.cpp
	$(CC) $(FLAGS) TGdesk_eksport_client_form.cpp
